...
- Create a small `.env.example` with keys and placeholder values, or
- Add an HTTP admin endpoint to trigger backfill from the browser (protected).

---

Generated by automation — ask me to adjust details (DB name, ports, or add `.env.example`).
