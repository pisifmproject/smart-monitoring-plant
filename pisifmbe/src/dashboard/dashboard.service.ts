  ...
  if (plantId.toUpperCase() === "CIKUPA") {
    try {
      ...
      lvmdpPanels = [
        {
          panelName: "LVMDP 1",
          voltage: parseFloat(String(panel1.rows[0]?.voltage_r ?? "0")),
          current: parseFloat(String(panel1.rows[0]?.current_r ?? "0")),
          power: parseFloat(String(panel1.rows[0]?.power ?? "0")),
          totalKwh: parseFloat(String(panel1.rows[0]?.kwh ?? "0")),
        },
        {
          panelName: "LVMDP 2",
          voltage: parseFloat(String(panel2.rows[0]?.voltage_r ?? "0")),
          current: parseFloat(String(panel2.rows[0]?.current_r ?? "0")),
          power: parseFloat(String(panel2.rows[0]?.power ?? "0")),
          totalKwh: parseFloat(String(panel2.rows[0]?.kwh ?? "0")),
        },
        {
          panelName: "LVMDP 3",
          voltage: parseFloat(String(panel3.rows[0]?.voltage_r ?? "0")),
          current: parseFloat(String(panel3.rows[0]?.current_r ?? "0")),
          power: parseFloat(String(panel3.rows[0]?.power ?? "0")),
          totalKwh: parseFloat(String(panel3.rows[0]?.kwh ?? "0")),
        },
        {
          panelName: "LVMDP 4",
          voltage: parseFloat(String(panel4.rows[0]?.voltage_r ?? "0")),
          current: parseFloat(String(panel4.rows[0]?.current_r ?? "0")),
          power: parseFloat(String(panel4.rows[0]?.power ?? "0")),
          totalKwh: parseFloat(String(panel4.rows[0]?.kwh ?? "0")),
        },
      ];
    } catch (error) {
