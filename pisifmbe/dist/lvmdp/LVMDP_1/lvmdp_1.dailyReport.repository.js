...
const getDailyReportsByDateRange = async (startDate, endDate) => {
    return await db_1.db
        .select()
        .from(schema_1.dailyReportLVMDP1)
        .where((0, drizzle_orm_1.and)((0, drizzle_orm_1.gte)(schema_1.dailyReportLVMDP1.reportDate, startDate), (0, drizzle_orm_1.lt)(schema_1.dailyReportLVMDP1.reportDate, endDate)))
        .orderBy(schema_1.dailyReportLVMDP1.reportDate);
};
