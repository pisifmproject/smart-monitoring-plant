...
const batchSaveHourlyReports = async (data) => {
    ...
    for (const record of data) {
        const result = await db_1.db
            .insert(schema_1.hourlyReportLVMDP2)
            .values(record)
            .onConflictDoUpdate({
            target: [schema_1.hourlyReportLVMDP2.reportDate, schema_1.hourlyReportLVMDP2.hour],
            set: {
                count: record.count,
...
const getHourlyReportByDate = async (dateStr) => {
    ...
    return await db_1.db
        .select()
        .from(schema_1.hourlyReportLVMDP2)
        .where((0, drizzle_orm_1.and)((0, drizzle_orm_1.gte)(schema_1.hourlyReportLVMDP2.reportDate, dateStr), (0, drizzle_orm_1.lt)(schema_1.hourlyReportLVMDP2.reportDate, nextDayStr)))
        .orderBy(schema_1.hourlyReportLVMDP2.hour);
};
...
const getHourlyReportByRange = async (startDate, endDate) => {
    ...
    return await db_1.db
        .select()
        .from(schema_1.hourlyReportLVMDP2)
        .where((0, drizzle_orm_1.and)((0, drizzle_orm_1.gte)(schema_1.hourlyReportLVMDP2.reportDate, startDate), (0, drizzle_orm_1.lt)(schema_1.hourlyReportLVMDP2.reportDate, nextDayStr)))
        .orderBy(schema_1.hourlyReportLVMDP2.reportDate, schema_1.hourlyReportLVMDP2.hour);
};
...
const getHourlyReportByDateHour = async (dateStr, hour) => {
    return await db_1.db
        .select()
        .from(schema_1.hourlyReportLVMDP2)
        .where((0, drizzle_orm_1.and)((0, drizzle_orm_1.eq)(schema_1.hourlyReportLVMDP2.reportDate, dateStr), (0, drizzle_orm_1.eq)(schema_1.hourlyReportLVMDP2.hour, hour)));
};
...
const deleteOldHourlyReports = async (beforeDate) => {
    return await db_1.db
        .delete(schema_1.hourlyReportLVMDP2)
        .where((0, drizzle_orm_1.lt)(schema_1.hourlyReportLVMDP2.reportDate, beforeDate));
};
