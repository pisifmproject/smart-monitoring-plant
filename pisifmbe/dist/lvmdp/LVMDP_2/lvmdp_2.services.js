...
exports.getHourlyAveragesLVMDP2 = exports.getShiftAveragesLVMDP2 = exports.getAllLVMDPs = void 0;
const lvmdp_2_repository_1 = require("./lvmdp_2.repository");
const getAllLVMDPs = async () => {
    return await (0, lvmdp_2_repository_1.findLVMDPs)();
};
...
const getShiftAveragesLVMDP2 = async (dateStr) => {
    const today = dateStr ?? new Date().toISOString().slice(0, 10);
    // Pass date filter to reduce data fetched from DB
    const allRows = await (0, lvmdp_2_repository_1.findLVMDPs)(today);
...
exports.getHourlyAveragesLVMDP2 = getHourlyAveragesLVMDP2;
