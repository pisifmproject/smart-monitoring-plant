...
const repo = __importStar(require("./lvmdp_2.repository"));
const r = express_1.default.Router();
r.get("/", async (_req, res) => {
    const rows = await (0, lvmdp_2_services_1.getAllLVMDPs)();
    res.json(rows);
});
...
r.get("/shift-avg", async (req, res) => {
    ...
    const data = await (0, lvmdp_2_services_1.getShiftAveragesLVMDP2)(date);
