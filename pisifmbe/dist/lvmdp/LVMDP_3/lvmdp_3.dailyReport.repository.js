...
const getAllDailyReports = async () => {
    return await db_1.db
        .select()
        .from(schema_1.dailyReportLVMDP3)
        .orderBy((0, drizzle_orm_1.desc)(schema_1.dailyReportLVMDP3.reportDate));
};
...
const getDailyReportsByDateRange = async (startDate, endDate) => {
    return await db_1.db
        .select()
        .from(schema_1.dailyReportLVMDP3)
        .where((0, drizzle_orm_1.and)((0, drizzle_orm_1.gte)(schema_1.dailyReportLVMDP3.reportDate, startDate), (0, drizzle_orm_1.lt)(schema_1.dailyReportLVMDP3.reportDate, endDate)))
        .orderBy(schema_1.dailyReportLVMDP3.reportDate);
};
