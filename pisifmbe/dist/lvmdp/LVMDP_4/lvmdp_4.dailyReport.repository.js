...
const saveDailyReport = async (data) => {
    return await db_1.db
        .insert(schema_1.dailyReportLVMDP4)
        .values(data)
        .onConflictDoUpdate({
        target: schema_1.dailyReportLVMDP4.reportDate,
        set: {
...
const getDailyReportByDate = async (date) => {
    ...
    return await db_1.db
        ...
        .where((0, drizzle_orm_1.and)((0, drizzle_orm_1.gte)(schema_1.dailyReportLVMDP4.reportDate, start), (0, drizzle_orm_1.lt)(schema_1.dailyReportLVMDP4.reportDate, end)));
};
