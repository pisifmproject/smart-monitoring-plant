...
exports.findLatestHMI4 = findLatestHMI4;
...
async function findLatestLVMDP4() {
    ...
    try {
        const result = await db_1.db.execute((0, drizzle_orm_1.sql) `SELECT * FROM public.v_lvmdp_4 
          ORDER BY waktu DESC 
          LIMIT 1`);
