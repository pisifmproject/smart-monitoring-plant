...
exports.getHourlyAveragesLVMDP4 = exports.getShiftAveragesLVMDP4 = exports.getAllLVMDPs = void 0;
const lvmdp_4_repository_1 = require("./lvmdp_4.repository");
const getAllLVMDPs = async () => {
    return await (0, lvmdp_4_repository_1.findLVMDPs)();
};
...
const getShiftAveragesLVMDP4 = async (dateStr) => {
    const today = dateStr ?? new Date().toISOString().slice(0, 10);
    // Pass date filter to reduce data fetched from DB
    const allRows = await (0, lvmdp_4_repository_1.findLVMDPs)(today);
...
exports.getHourlyAveragesLVMDP4 = getHourlyAveragesLVMDP4;
