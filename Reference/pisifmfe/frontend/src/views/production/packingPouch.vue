...
const fetchProductionData = async () => {
  ...
  try {
    ...
    productionData.value.powerConsumption = 45 + (Math.random() * 2 - 1);
    productionData.value.voltageInput = 380 + (Math.random() * 1 - 0.5);
    productionData.value.currentAmpere = 120 + (Math.random() * 5 - 2.5);
  } catch (err) {
