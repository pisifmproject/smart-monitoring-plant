        ...
        <div class="header-content">
          <div class="header-left">
            ...
            <div class="header-text">
              <h1 class="page-title">Production Line TWS56</h1>
              <p class="page-subtitle">Twin Screw Extruder Production Line</p>
            </div>
          </div>
          <div class="header-actions">
            ...
            <div v-if="canAccessDailyReport()" class="report-btn-wrapper">
              <ReportButton routeName="dailyReportTWS56" label="Daily Report" />
            </div>
          </div>
        </div>
      </div>
