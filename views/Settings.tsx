...
import { UserRole, VisibilityCategory, VisibilityGroup, DataItem } from '../types';
...
const SettingsView: React.FC<SettingsProps> = ({ userRole }) => {
    ...
    // Get machine visibility items for the selected plant
    ...
    // Filter Items based on Plant Scope AND Category Filter for generic view
    ...
    // Group the filtered items by Category -> Group for generic view
    ...
    const renderVisibilitySettings = () => {
        // Renders the main content based on filters
        const renderContent = () => {
            // New View: Machine Detail for a specific plant
